...
module.exports = {
  ...
  async execute(interaction) {
    // On defer pour éviter le timeout de 3s
    ...
    try {
      ...
      console.error(`[Missions] Erreur execution : ${err.message}`);
      return interaction.editReply({ content: 'Une erreur est survenue lors de la récupération de vos missions.' }).catch(() => {});
    }
  },
};
